...
import GridSuperescalarOrdem from "../GridSuperescalar/GridSuperescalarOrdem";
...
const Layout = () => {
  ...
  //   const instructions = [
  //       { value: "ADD", type: "RR", resourceUnit: "ALU" as const, latency: 1 },
  //       { value: "SUB", type: "RR", resourceUnit: "ALU" as const, latency: 1 },
  //       { value: "MUL", type: "RI", resourceUnit: "MUL" as const, latency: 2 },
  //       { value: "DIV", type: "RI", resourceUnit: "MUL" as const, latency: 2 },
  //       { value: "LW", type: "RM", resourceUnit: "LSU" as const, latency: 2 },
  //       { value: "SW", type: "RM", resourceUnit: "LSU" as const, latency: 2 },
  //   ];
  ...
  return (
    <div className={styles.container}>
      <div className={styles.simulator}>
        ...
        {/* Pipeline Grid */}
        {selectedPipeline === "escalar" ? <GridEscalar /> : (selectedMultithreading === "SMT" || selectedMultithreading === "BMT")? <GridSuperescalar /> : <GridSuperescalarOrdem />}
